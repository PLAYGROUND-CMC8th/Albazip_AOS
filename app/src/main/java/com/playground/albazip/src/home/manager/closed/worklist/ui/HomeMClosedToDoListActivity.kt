...
import com.playground.albazip.src.home.manager.worklist.ui.ChildFragmentPersonal

// 닫은 매장에서는 업무 변경이 안됨
class HomeMClosedToDoListActivity :
    ...
    override fun onGetMTaskSuccess(response: GetMTodayTaskResponse) {
        ...
        pagerAdapter.addFragment(ChildFragmentClosedTogether(response.data))
