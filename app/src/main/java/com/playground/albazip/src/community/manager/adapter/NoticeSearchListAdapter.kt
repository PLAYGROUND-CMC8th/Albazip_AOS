package com.playground.albazip.src.community.manager.adapter
...
class NoticeSearchListAdapter(context: Context, val itemList:ArrayList<NoticeData>): RecyclerView.Adapter<NoticeSearchListAdapter.NoticeHolder>(),
