...
import com.playground.albazip.databinding.ActivityReInputPhoneBinding
...
class ReInputPhoneActivity : BaseActivity<ActivityReInputPhoneBinding>(
    ActivityReInputPhoneBinding::inflate
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (s!!.isEmpty()) {
                    binding.etInputPhone.typeface =
                        ResourcesCompat.getFont(this@ReInputPhoneActivity, R.font.roboto_medium_otf)
                    binding.etInputPhone.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16F)
                } else {
                    binding.etInputPhone.typeface =
                        ResourcesCompat.getFont(this@ReInputPhoneActivity, R.font.roboto_bold_otf)
    ...
    private fun startPhoneNumberVerification(phoneNumber: String) {
        ...
        val options = PhoneAuthOptions.newBuilder(auth)
            ...
            .setActivity(this@ReInputPhoneActivity)                 // Activity (for callback binding)
    ...
    private fun signInWithPhoneAuthCredential(credential: PhoneAuthCredential) {
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this@ReInputPhoneActivity) { task ->
    ...
    private fun deleteAccount() {
        ...
        user.delete().addOnCompleteListener {
            if (it.isSuccessful) {
                ...
                // 화면 전환
                val nextIntent = Intent(this@ReInputPhoneActivity, RePWActivity::class.java)
                nextIntent.putExtra(
                    "phoneNum",
                    binding.etInputPhone.text.toString().replace(" ", "")
                )
                ...
                Toast.makeText(this@ReInputPhoneActivity, "유저정보 삭제 실패 ", Toast.LENGTH_LONG).show()
            }
        }
    }
