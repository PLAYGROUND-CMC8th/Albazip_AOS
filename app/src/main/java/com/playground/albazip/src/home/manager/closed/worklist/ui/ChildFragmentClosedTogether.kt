package com.playground.albazip.src.home.manager.closed.worklist.ui
...
import com.playground.albazip.src.home.manager.closed.worklist.adapter.FTogetherDoneAdapter
import com.playground.albazip.src.home.manager.closed.worklist.adapter.FUnDoneAdapter
...
class ChildFragmentClosedTogether(data: MTodayTaskResult?) : BaseFragment<ChildFragmentTogetherBinding>(
    ...
    private lateinit var unDoneAdapter: FUnDoneAdapter

    // 완료 리스트
    private var doneList = ArrayList<HDoneWorkListData>()
    private lateinit var doneAdpater: FTogetherDoneAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        unDoneAdapter = FUnDoneAdapter(unDoneList,requireContext(),dialogBinding.root)
        ...
        doneAdpater = FTogetherDoneAdapter(parentFragmentManager,requireContext(),doneList,ResultData!!.coTask.comWorker.comWorker)
    ...
    override fun onGetHomeCoWorkSuccess(response: HomeCoWorkResponse) {
        ...
        doneAdpater = FTogetherDoneAdapter(parentFragmentManager,requireContext(),doneList,response.data.comWorker.comWorker)
        binding.rvDone.adapter = doneAdpater
